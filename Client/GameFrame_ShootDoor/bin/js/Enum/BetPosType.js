...
(function (Enum) {
    ...
    var BetMoreTxtType;
    (function (BetMoreTxtType) {
        BetMoreTxtType[BetMoreTxtType["POKER_A"] = 1] = "POKER_A";
        BetMoreTxtType[BetMoreTxtType["POKER_2"] = 2] = "POKER_2";
        BetMoreTxtType[BetMoreTxtType["POKER_3"] = 3] = "POKER_3";
        BetMoreTxtType[BetMoreTxtType["POKER_4"] = 4] = "POKER_4";
        BetMoreTxtType[BetMoreTxtType["POKER_5"] = 5] = "POKER_5";
        BetMoreTxtType[BetMoreTxtType["POKER_6"] = 6] = "POKER_6";
        BetMoreTxtType[BetMoreTxtType["POKER_7"] = 7] = "POKER_7";
        BetMoreTxtType[BetMoreTxtType["POKER_8"] = 8] = "POKER_8";
        BetMoreTxtType[BetMoreTxtType["POKER_9"] = 9] = "POKER_9";
        BetMoreTxtType[BetMoreTxtType["POKER_10"] = 10] = "POKER_10";
        BetMoreTxtType[BetMoreTxtType["POKER_J"] = 11] = "POKER_J";
        BetMoreTxtType[BetMoreTxtType["POKER_Q"] = 12] = "POKER_Q";
        BetMoreTxtType[BetMoreTxtType["POKER_K"] = 0] = "POKER_K";
    })(BetMoreTxtType = Enum.BetMoreTxtType || (Enum.BetMoreTxtType = {}));
})(Enum || (Enum = {}));
