class InitState {
    constructor() {
        ...
        let width: number = Laya.Browser.clientHeight >= Laya.Browser.clientWidth ? Laya.Browser.clientHeight : Laya.Browser.clientWidth;
        let height: number = Laya.Browser.clientHeight >= Laya.Browser.clientWidth ? Laya.Browser.clientWidth : Laya.Browser.clientHeight;
