...
exports.Enhance = (ComposedComponent, option) => class extends React.Component {
    constructor(props) {
        super(props);
        this.show = (params) => {
        ...
        this.state = Object.assign({ alertShow: false, Title: "提示", Content: "内容区域", HideOk: false, HideCancel: false, Ok: null, Cancel: null, OkText: "确定", CancelText: "取消", OkColor: "#3a66b3", CancelColor: "gray" }, option);
    }
    componentDidMount() {
    }
    render() {
