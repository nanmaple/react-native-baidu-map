class LoginView {
    ...
    constructor(successHandler: Laya.Handler) {
        ...
        Laya.loader.load(skins, Laya.Handler.create(this, () => {
            ...
            this.Button = this.ButtonCreate(220, 800, 300, 60, "测试UI", false, true);
        }));
    }
    ...
    private ButtonCreate(x, y, w, h, label, isTourist, testView?: boolean) {
    ...
    private Login(isTourist, testView) {
        //获取Socket Token
