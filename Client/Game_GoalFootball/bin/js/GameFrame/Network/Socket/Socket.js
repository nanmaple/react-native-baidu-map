...
(function (Network) {
    var Socket = /** @class */ (function () {
         ...
         */
        Socket.prototype.Connect = function (url, isReConnect) {
         ...
         * @param msg
         */
        Socket.prototype.onOpen = function (msg) {
         ...
         * @param msg
         */
        Socket.prototype.onClose = function (msg) {
         ...
         * 转二进制发送
         */
        Socket.prototype.SendBinary = function (msg) {
            if (this.socket.connected) {
         ...
         */
        Socket.prototype.GetConnectState = function () {
            if (!this.socket) {
                return false;
            }
         ...
         * @param status 网络是否通畅
         */
        Socket.prototype.SetNetwork = function (status) {
         ...
         * @param status
         */
        Socket.prototype.SetReConnect = function (status) {
            this.isReConnect = status;
        };
        return Socket;
    }());
