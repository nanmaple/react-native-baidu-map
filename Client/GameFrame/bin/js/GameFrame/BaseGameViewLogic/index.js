...
var BaseGameViewLogic = /** @class */ (function (_super) {
     ...
     * @param isVer
     */
    BaseGameViewLogic.prototype.InitView = function (isVer) {
        if (isVer === void 0) { isVer = true; }
        if (this.onLoadSuccess && this.onLoginSucess) {
            this.alertView.ResetScreen(isVer);
            this.loadingView.ResetScreen(isVer);
        }
        else {
            this.gameLoadView && this.gameLoadView.ResetScreen(isVer);
        }
    };
    /**
     * 日志
