var LoginView = /** @class */ (function () {
    function LoginView(successHandler) {
        ...
        Laya.loader.load(skins, Laya.Handler.create(this, function () {
            //设置画布的背景颜色
            _this.Account = _this.InputCreate(220, 200, 300, 60);
            _this.Password = _this.InputCreate(220, 300, 300, 60);
            _this.Button = _this.ButtonCreate(220, 400, 300, 60, "登录");
        }));
    }
    LoginView.prototype.InputCreate = function (x, y, w, h) {
    ...
    LoginView.prototype.ButtonCreate = function (x, y, w, h, label) {
