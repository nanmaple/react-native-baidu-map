...
(function (ui) {
    var BetBtnVUI = /** @class */ (function (_super) {
        ...
        BetBtnVUI.uiView = { "type": "View", "props": { "width": 200, "height": 70 }, "child": [{ "type": "Label", "props": { "width": 60, "var": "betName", "valign": "middle", "text": "label", "name": "betName", "left": 20, "height": 40, "fontSize": 28, "color": "#faf114", "centerY": 0, "align": "center" } }, { "type": "Label", "props": { "width": 60, "valign": "middle", "text": "---", "right": 20, "name": "betOdd", "height": 40, "fontSize": 28, "color": "#f6e03b", "centerY": 0, "align": "center" } }, { "type": "Button", "props": { "y": -2, "var": "betBtn", "stateNum": 1, "skin": "ui/btn_chip.png", "name": "betBtn", "left": 20, "label": "1", "centerY": 0 } }] };
        return BetBtnVUI;
    }(View));
...
(function (ui) {
    var GameBgHUI = /** @class */ (function (_super) {
        ...
        GameBgHUI.uiView = { "type": "View", "props": { "width": 1334, "height": 750 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 1334, "skin": "ui/gameBg.png", "height": 750 } }, { "type": "Image", "props": { "y": 372, "x": 471, "var": "close", "skin": "ui/close.png" } }] };
        return GameBgHUI;
    }(View));
...
(function (ui) {
    var GameBgVUI = /** @class */ (function (_super) {
        ...
        GameBgVUI.uiView = { "type": "View", "props": { "width": 750, "height": 1334 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "skin": "ui/gameBg_v.png" } }, { "type": "Image", "props": { "y": 268, "x": 86, "var": "close", "skin": "ui/close.png" } }] };
        return GameBgVUI;
    }(View));
...
(function (ui) {
    var LoadingHUI = /** @class */ (function (_super) {
        ...
        LoadingHUI.uiView = { "type": "View", "props": { "width": 1334, "height": 750 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 1334, "skin": "ui/maskBg.png", "height": 750 } }, { "type": "Label", "props": { "width": 242.798828125, "visible": false, "var": "txt", "text": "connecting server...", "strokeColor": "#d00400", "stroke": 5, "height": 28, "fontSize": 28, "color": "#fbff70", "centerY": 0, "centerX": 0, "anchorY": 0.5, "anchorX": 0.5 } }] };
        return LoadingHUI;
    }(View));
...
(function (ui) {
    var LoadingVUI = /** @class */ (function (_super) {
        ...
        LoadingVUI.uiView = { "type": "View", "props": { "width": 750, "height": 1334 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 750, "skin": "ui/maskBg.png", "height": 1334 } }, { "type": "Label", "props": { "width": 242.798828125, "visible": false, "var": "txt", "text": "connecting server...", "strokeColor": "#d00400", "stroke": 5, "height": 28, "fontSize": 28, "color": "#fbff70", "centerY": 0, "centerX": 0, "anchorY": 0.5, "anchorX": 0.5 } }] };
        return LoadingVUI;
    }(View));
